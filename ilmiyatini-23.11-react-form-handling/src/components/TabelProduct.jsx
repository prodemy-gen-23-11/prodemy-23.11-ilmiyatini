  ...
  return (
    <div className="container mx-auto mt-4">
      ...
      <div className="flex justify-end ">
        <Link to={"/addNP"}>
          <button className="bg-lime-500 text-white py-2 px-4 mb-2 rounded text-sm mt-4 hover:bg-amber-300">
            Add New Product
          </button>
        </Link>
      </div>
                ...
                <tr key={product.id}>
                  ...
                  <td className="border border-yellow-400 px-4 py-2">
                    <Link to={`/product/${product.id}`}>
                      <button className="bg-amber-300 hover:bg-amber-400 text-white py-2 px-4 mr-2 text-sm rounded">
                        Show
                      </button>
                    </Link>

                    <button className="bg-cyan-500 hover:bg-cyan-700 text-white py-2 px-4 mr-2  text-sm rounded">
                      Edit
                    </button>
                    <button className="bg-rose-400 hover:bg-rose-700 text-white py-2 px-4 mr-2 text-sm rounded">
                      Delete
                    </button>
                  </td>
                </tr>
