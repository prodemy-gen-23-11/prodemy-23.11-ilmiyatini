        ...
        <div className='product-card'>
            ...
            <div className='product-details'>
                ...
                <div className='price-product'>
                    <span className='line-through text-gray-400 '>$1999</span> $ {price} <button class='discount'>-20%</button>
                </div>
                <p>In stock</p>
                ...
                <div className='buy-button'>
                    ...
                    <Button type='button' label='Add to cart' icon='fas fa-shopping-cart text-xs' variant='secondary' />
                </div>
